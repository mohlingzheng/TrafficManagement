...
public class RoadTrafficDensity : MonoBehaviour
{
    ...
    private void CalculateActualWeight()
    {
        float trafficDensityNormalised = (TrafficDensity - WeightConstant.TrafficDensityMin) / (WeightConstant.TrafficDensityMax - WeightConstant.TrafficDensityMin);
        float weightNormalised = WeightConstant.TrafficDensityCoefficient * trafficDensityNormalised;
        WeightValue = weightNormalised + RoadLength;
    }
